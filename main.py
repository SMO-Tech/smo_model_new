...
def main():
    ...
    #Read Video - Using full resolution now that GPU is available
    #GPU can handle full 1920x1080 resolution efficiently
    video_frames, original_fps = read_video(input_video_path, max_width=None, max_height=None)
